...
|---|---|---|---|---|---|---|---|
| `airi-workflow-wizard` | [`airi-workflow-wizard.md`](./airi-workflow-wizard.md) | User requests multi-type upload, numbered/custom style selection, analysis prompt packs, or editable page-by-page copy/image confirmation | A PPT Master project can be initialized | Not a standalone SaaS or 1:1 PPTX preservation route | Before main Step 1 / through Strategist confirmation | Source inventory/synthesis, selected/generated images, hash-confirmed page outline | Blocks before Executor until current outline is confirmed |
