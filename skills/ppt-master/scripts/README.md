...
| Image tools | `image_gen.py`, `analysis_pack.py`, `latex_render.py`, `analyze_images.py`, `gemini_watermark_remover.py` | [docs/image.md](./docs/image.md), [docs/analysis-packs.md](./docs/analysis-packs.md) |
